...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
      <div class="container">
        <a class="navbar-brand" href="/LearningPHP/6.3/">PHP Fundamentals: <?= $view_bag['title']; ?></a>
        <?php if (is_user_authenticated() === false): ?>
          <a class="navbar-brand" href="/LearningPHP/6.3/login.php">Login</a>
        <?php else: ?>
          <a class="navbar-brand" href="/LearningPHP/6.3/logout.php">Logout</a>
        <?php endif ?>
      </div>
    </nav>
